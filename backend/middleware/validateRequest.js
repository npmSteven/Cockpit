...
const {
  channelValidationSettingsUpdate,
  channelValidationChannelId,
} = require('../validation/channelValidation');
const {
  floatplaneLoginValidation,
} = require('../validation/floatplaneLoginValidation');
const {
  floatplaneTokenValidation,
} = require('../validation/floatplaneTokenValidation');
...
module.exports.validateChannelSettingsUpdateRequest = (req, res, next) => {
  const { error, value } = channelValidationSettingsUpdate.validate({
    ...req.params,
    ...req.body,
  });
  if (error) {
